        ...
        <VStack spacing={8} align="start">
            ...
            <Divider />
                ...
                <Box>
                    ...
                    <Text>
                        Innovative software engineer with strong foundations in computer science.
                        Proficient in multiple programming languages and frameworks, with
                ...
                <Box>
                    ...
                    <Text>
                        Go, TypeScript/JavaScript, HTML, CSS, Fiber, ChakraUI,
                        React/Angular, Vite, Bootstrap, NodeJS, SQL/NoSQL,
                        Docker, Git, Linux, AWS, Postman
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        Docker, and MySQL.
                        • Collaborate in a SCRUM team to ensure prompt delivery and
                    ...
                    <Text>
                        • Developed web and mobile applications using HTML, CSS, JavaScript,
                        and Angular. Managed databases with MySQL and MongoDB. Collaborated
                        with clients, implemented RESTful APIs, conducted manual testing,
                ...
                <Box>
                    ...
                    <Text>
                        Relevant coursework: Data Structures, Full Stack Development, Software
                        Security, Software Testing, Client/Server Dev, Secure Coding, and more!
                    </Text>
                </Box>
            </VStack>
        </Box>
